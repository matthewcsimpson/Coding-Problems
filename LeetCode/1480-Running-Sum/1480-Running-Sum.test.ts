...
import runningSumTS from "./1480-Running-Sum";

test("1480-Running-Sum TS", () => {
  expect(runningSumTS(testNums1)).toStrictEqual(result1);
  expect(runningSumTS(testNums2)).toStrictEqual(result2);
});
