...
console.log(minimumHealth([2, 7, 4, 3], 4)); // 13
console.log(minimumHealth([2, 5, 3, 4], 7)); // 10
console.log(minimumHealth([3, 3, 3], 0)); // 10
console.log(minimumHealth([0], 0)); // 1
console.log(minimumHealth([3], 1)); // 3
